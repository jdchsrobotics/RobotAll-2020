...
public class xboxControllerMap extends GenericHID {

    public xboxControllerMap(int port){
                // Xbox Controller port
         super (OI_Constants.xbox_Controller_portID);
         HAL.report(tResourceType.kResourceType_XboxController,
         OI_Constants.xbox_Controller_portID + 1);
    //    public static final int OI_Constants.xbox_Controller_portID = 1;
    }
    /**
     * 
